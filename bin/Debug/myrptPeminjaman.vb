...
Public Class myrptPeminjaman
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "perpus_smkpelitaalam.myrptPeminjaman.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedmyrptPeminjaman
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As myrptPeminjaman = New myrptPeminjaman()
        rpt.Site = Me.Site
        Return rpt
    End Function
