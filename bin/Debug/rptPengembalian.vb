...
Public Class rptPengembalian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "perpus_smkpelitaalam.rptPengembalian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPengembalian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPengembalian = New rptPengembalian()
        rpt.Site = Me.Site
        Return rpt
    End Function
