...
Public Class rptPeminjaman
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "perpus_smkpelitaalam.rptPeminjaman.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPeminjaman
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPeminjaman = New rptPeminjaman()
        rpt.Site = Me.Site
        Return rpt
    End Function
