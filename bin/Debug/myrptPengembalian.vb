...
Public Class myrptPengembalian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "perpus_smkpelitaalam.myrptPengembalian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedmyrptPengembalian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As myrptPengembalian = New myrptPengembalian()
        rpt.Site = Me.Site
        Return rpt
    End Function
